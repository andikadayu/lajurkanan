<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        <a class="navbar-brand" href="scrap.php">Lajur Kanan</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link <?php if (strpos($_SERVER['REQUEST_URI'], 'scrap.php') !== false) {
                                            echo 'active';
                                        } ?>" <?php if (strpos($_SERVER['REQUEST_URI'], 'scrap.php') !== false) {
                ...
                <li class="nav-item">
                    <a class="nav-link <?php if (strpos($_SERVER['REQUEST_URI'], 'shopee_page.php') !== false) {
                                            echo 'active';
                                        } ?>" <?php if (strpos($_SERVER['REQUEST_URI'], 'shopee_page.php') !== false) {
                                                    echo "aria-current='true'";
                ...
                <li class="nav-item">
                    <a class="nav-link <?php if (strpos($_SERVER['REQUEST_URI'], 'lazada_page.php') !== false) {
                                            echo 'active';
                                        } ?>" <?php if (strpos($_SERVER['REQUEST_URI'], 'lazada_page.php') !== false) {
                                                    echo "aria-current='true'";
                ...
                <li class="nav-item">
                    <a class="nav-link <?php if (strpos($_SERVER['REQUEST_URI'], 'profile.php') !== false) {
                                            echo 'active';
                                        } ?>" <?php if (strpos($_SERVER['REQUEST_URI'], 'profile.php') !== false) {
                                                    echo "aria-current='true'";
                ...
                <?php if ($_SESSION['role'] == 'superadmin') { ?>
                    <li class="nav-item">
                        <a class="nav-link <?php if (strpos($_SERVER['REQUEST_URI'], 'manage_admin.php') !== false) {
                                                echo 'active';
                                            } ?>" <?php if (strpos($_SERVER['REQUEST_URI'], 'manage_admin.php') !== false) {
                                                        echo "aria-current='true'";
